...
class Balance::ForwardCalculatorTest < ActiveSupport::TestCase
  ...
  test "calculation start date falls back to the first posted entry without an opening anchor" do
    account = create_account_with_ledger(
      account: { type: Depository, currency: "USD" },
      entries: [
        { type: "transaction", date: 5.days.ago.to_date, amount: -100 },
    ...
    assert_equal 2.days.ago.to_date, calculator.calculation_start_date
  end
